...
import ContactForm from "@/models/appointment";
import moment from "moment";
export default async function handler(req, res) {
  if (req.method === "POST") {
    try {
      const { name, email, phone, note, date, timeSlot, budget } = req.body;
      const formattedDate = moment(date).format("YYYY-MM-DD");
      const formattedTimeSlot = `Section: ${timeSlot.section}, Time: ${timeSlot.time}`;
          ...
          <div class="email-container">
            ...
            <div class="content">
              ...
              <ul>
                ...
                <li><strong>TimeSlot:</strong> ${formattedTimeSlot}</li>
                <li><strong>Project Details:</strong> ${note}</li>
              </ul>
