...
import CareerForm from "@/models/CareerFormSchema";

export default async function handler(req, res) {
  if (req.method === "POST") {
    try {
      const { name, email, education, experience, projectDetails } = req.body;
      console.log(name, email, education, experience, projectDetails);
      ...
      const sendSubmitterEmail = {
        ...
        html: `
          ...
          <div class="email-container">
            ...
            <div class="content">
              <h3>Dear ${name},</h3>
              <p>Thank you for reaching out to us! Our team will review your form details and get back to you soon.</p>
              <p>Here are the details you submitted:</p>
              <ul>
                <li><strong>Eduation:</strong> ${education}</li>
                <li><strong>Experience:</strong> ${experience}</li>
                <li><strong>About you:</strong> ${projectDetails}</li>
              </ul>
      ...
      const sendOwnerEmail = {
        ...
        html: `
          ...
          <div class="email-container">
            ...
            <div class="content">
              <h3>New Career Submission</h3>
              <p>Details of the submission are as follows:</p>
              <ul>
                <li><strong>Name:</strong> ${name}</li>
                <li><strong>Email:</strong> ${email}</li>
                <li><strong>Budget:</strong> ${education}</li>
                <li><strong>Timeframe:</strong> ${experience}</li>
                <li><strong>Details:</strong> ${projectDetails}</li>
              </ul>
            </div>
            <div class="footer">
              <p>&copy; ${new Date().getFullYear()} CrypthonLab. All rights reserved.</p>
